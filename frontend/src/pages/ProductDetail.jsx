...
import { HiOutlineMinus, HiOutlinePlus, HiOutlineShoppingBag, HiOutlineHeart, HiOutlineArrowLeft } from 'react-icons/hi'
...
export default function ProductDetail() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Link to="/products" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-hotpink-500 mb-8 transition-colors">
