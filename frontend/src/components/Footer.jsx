  ...
  return (
    <footer className="bg-white border-t-2 border-pink-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-serif text-xl font-bold text-hotpink-600">
                Knotify
              </span>
            </div>

            <p className="text-sm text-gray-500 leading-relaxed">
              Handcrafted with love. Every stitch tells a story of warmth,
              care, and creativity.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/products"
                  className="text-sm text-gray-500 hover:text-hotpink-500 transition-colors"
                >
                  All Products
                </Link>
              </li>
              ...
              <li>
                <Link
                  to="/products?category=Amigurumi"
                  className="text-sm text-gray-500 hover:text-hotpink-500 transition-colors"
                >
                  Amigurumi
                </Link>
        ...
        {/* Bottom */}
        <div className="border-t border-pink-100 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-400 flex items-center gap-1">
            Made with
            <HiOutlineHeart className="w-4 h-4 text-hotpink-500" />
            and lots of yarn
          </p>
        </div>
      </div>
